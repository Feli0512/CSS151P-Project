          ...
          <div className="divide-y divide-gray-200">
            ...
            <div
              ...
              className="p-6 flex flex-col md:flex-row md:items-center justify-between gap-4 hover:bg-gray-50 transition-colors">
                  ...
                  disabled={loadingActions.has(req.id)}
                  className="text-red-600 border-red-200 hover:bg-red-50">
                  
                      {loadingActions.has(req.id) ? <Loader2Icon className="w-4 h-4 mr-2 animate-spin" /> : <XIcon className="w-4 h-4 mr-2" />} Reject
                    </Button>
                    <Button
                  ...
                  className="bg-green-600 hover:bg-green-700">
                      ...
                      {loadingActions.has(req.id) ? <Loader2Icon className="w-4 h-4 mr-2 animate-spin" /> : <CheckIcon className="w-4 h-4 mr-2" />} Approve
                    </Button>
                  </div>
                </div>
            )}
