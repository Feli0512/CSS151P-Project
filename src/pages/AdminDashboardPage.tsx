  ...
  return (
    <div className="space-y-8">
      <motion.div
        ...
        <div className="absolute right-0 top-0 w-64 h-full bg-linear-to-l from-[#1B2A4A]/5 to-transparent pointer-events-none"></div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div
                  ...
                  className="flex items-start p-3 bg-red-50 text-red-800 rounded-lg border border-red-100">
                      ...
                      <AlertTriangleIcon className="w-5 h-5 mr-3 mt-0.5 shrink-0 text-red-500" />
                      <div>
                ...
                <div
                  ...
                  className="flex items-start p-3 bg-orange-50 text-orange-800 rounded-lg border border-orange-100">
                      ...
                      <ClockIcon className="w-5 h-5 mr-3 mt-0.5 shrink-0 text-orange-500" />
                      <div>
