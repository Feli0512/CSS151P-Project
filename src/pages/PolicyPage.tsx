      ...
      <motion.div
        ...
        <motion.div
          ...
          <div className="flex items-start">
            <AlertTriangleIcon className="h-6 w-6 text-amber-600 mt-0.5 flex-shrink-0" />
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-amber-700 space-y-2">
                ...
                <p className="flex items-center text-amber-800 font-medium bg-amber-100/50 p-2 rounded inline-flex mt-2">
